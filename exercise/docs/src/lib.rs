...
//!
//! ![blabla](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/700px-FrenchMarketPumpkinsB.jpg)
...
/// - blabal bla
pub struct Pumpkin {
    /// `roundness` A percentage
    pub roundness: f32,
    /// `orangeness` Number between 8 and 27
    pub orangeness: i32,
}
...
impl Pumpkin {
    /// If [`Pumpkin::smash`] is called the pumpkin will be gone, so you can't make pie. 🐓
    pub fn smash(self) {}
}
...
/// This is for the orangeness field in [`Pumpkin`]
